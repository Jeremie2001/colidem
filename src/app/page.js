...
export default function Home() {
  ...
  const joursAvantTabaski = Math.max(0, Math.ceil((new Date('2026-05-27') - new Date()) / (1000 * 60 * 60 * 24)))
  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-bold text-amber-800">
              Tabaski 2026 — Envoyez vos boubous et cadeaux !
            </p>
            <p className="text-xs text-amber-600 hidden md:block">
              Trouvez un voyageur avant le 27 mai — Europe, États-Unis, Canada
            </p>
          </div>
          <span className="text-xs font-bold text-amber-700 bg-amber-100 px-3 py-1 rounded-full whitespace-nowrap">
            J-{joursAvantTabaski}
          </span>
        </div>
      </section> */}
      ...
      <section className="relative text-white text-center overflow-hidden" style={{ minHeight: '420px' }}>
        ...
        <div className="relative z-10 px-6 py-16">
          <div className="inline-block bg-green-500 bg-opacity-40 text-green-100 text-xs font-semibold px-4 py-1.5 rounded-full mb-4">
            🌍 Afrique ↔ Monde entier
          </div>
          <h2 className="text-4xl font-black mb-3 leading-tight">
            Envoyez vos colis<br />facilement
          </h2>
          <p className="text-green-100 text-lg mb-8 max-w-xl mx-auto">
            Trouvez un voyageur qui part vers votre destination — Intra-Afrique, Europe, États-Unis, Canada
          </p>
          ...
          <div className="flex justify-center gap-8 mt-8">
            ...
            <div className="w-px bg-green-600 hidden md:block"></div>
            <div className="text-center">
              <p className="text-2xl font-black">4</p>
              <p className="text-green-200 text-xs mt-1">Continents couverts</p>
            </div>
            <div className="w-px bg-green-600 hidden md:block"></div>
            <div className="text-center">
      ...
      <section className="bg-white py-10 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-sm text-gray-400 mb-8">
            Colidem couvre tous les corridors Afrique — Monde
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <div className="bg-green-50 rounded-2xl p-4 text-center">
              <p className="text-2xl mb-2">🌍↔️🌍</p>
              <p className="text-sm font-bold text-gray-800">Intra-Afrique</p>
              <p className="text-xs text-gray-400 mt-1">Dakar, Abidjan, Maroc, Mali, Ghana...</p>
            </div>
            <div className="bg-blue-50 rounded-2xl p-4 text-center">
              <p className="text-2xl mb-2">🌍↔️🇪🇺</p>
              <p className="text-sm font-bold text-gray-800">Europe</p>
              <p className="text-xs text-gray-400 mt-1">France, Espagne, Italie, Portugal...</p>
            </div>
            <div className="bg-red-50 rounded-2xl p-4 text-center">
              <p className="text-2xl mb-2">🌍↔️🇺🇸</p>
              <p className="text-sm font-bold text-gray-800">États-Unis</p>
              <p className="text-xs text-gray-400 mt-1">New York, Atlanta, Washington...</p>
            </div>
            <div className="bg-amber-50 rounded-2xl p-4 text-center">
              <p className="text-2xl mb-2">🌍↔️🇨🇦</p>
              <p className="text-sm font-bold text-gray-800">Canada</p>
              <p className="text-xs text-gray-400 mt-1">Montréal, Toronto, Ottawa...</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">Trouve un voyageur ou GP qui part vers ta destination</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-3">
                💬
              </div>
              <p className="font-semibold text-gray-800 mb-1">Réserve et contacte</p>
              <p className="text-sm text-gray-500">Réserve tes kilos et contacte directement via WhatsApp</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-3">
                📦
      ...
      <footer className="bg-white border-t border-gray-100 px-6 py-8 text-center">
        ...
        <p className="text-sm text-gray-400">La marketplace du bagage partagé — Afrique et Monde entier</p>
